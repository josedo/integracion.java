 ...
 * @author jose.becerra
 */
@WebServlet(name = "PartiesGetDelete", urlPatterns = {"/mantenedores/partidos/update"})
public class PartiesGetDelete extends HttpServlet {
    ...
    private final services.maintainers.Parties port = this.partiesService.getPartiesPort();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = "";
        try {
            Part part = new Gson().fromJson( this.port.get( request.getParameter("id")), entities.Part.class );
            json = part.toString();
        } catch (Exception e) {
