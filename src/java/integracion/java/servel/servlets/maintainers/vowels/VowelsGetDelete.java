 ...
 * @author jose.becerra
 */
@WebServlet(name = "VocalsGetDelete", urlPatterns = {"/mantenedores/vocales/update"})
public class VowelsGetDelete extends HttpServlet {

    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_42724/Vowels/Vowels.wsdl")
    private Vowels_Service vowelsService;
        services.maintainers.Vowels port = this.vowelsService.getVowelsPort();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = "";
        try {
            Vowel vowel = new Gson().fromJson(this.port.get(request.getParameter("id")), entities.Vowel.class );
            json = vowel.toString();
        } catch (Exception e) {
