 ...
 * @author jose.becerra
 */
@WebServlet(name = "CandidatesGetDelete", urlPatterns = {"/mantenedores/candidatos/update"})
public class CandidatesGetDelete extends HttpServlet {
    ...
    private final Candidates port = this.candidatesService.getCandidatesPort();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = "";
        try {
            Candidate candidate = new Gson().fromJson( this.port.get(request.getParameter("id")), entities.Candidate.class );
